...
public class frmConsultaVentas extends javax.swing.JInternalFrame {
    ...
    public frmConsultaVentas(JFrame frmC) {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnPDFVentas2 = new javax.swing.JButton();
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(jdFecha1, javax.swing.GroupLayout.PREFERRED_SIZE, 167, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(lblTotalRegistros1)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(jdFecha2, javax.swing.GroupLayout.PREFERRED_SIZE, 167, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
        ...
        btnPDFVentas2.setText("Generar PDF");
        btnPDFVentas2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnPDFVentas2ActionPerformed(evt);
            }
        });
    ...
    Date fechaInicial = jdFecha1.getDate(); 
    Date fechaFinal = jdFecha2.getDate();

    // Validar que las fechas no sean nulas
    if (fechaInicial != null && fechaFinal != null) {
        // Llamar al método listarConsulta con la lógica de paginación
        boolean paginar = (cboNumPag.getSelectedItem() != null); // Verificar si hay un número de página seleccionado
